...
export const FEED_CATALOGUE = [
  ...
  { id: 'krone', name: 'Krone.at', url: 'https://api.krone.at/v1/rss/rssfeed-google.xml', category: 'news', language: 'de', enabled: false },
  { id: 'kurier', name: 'Kurier.at', url: 'https://kurier.at/xml/rssd', category: 'news', language: 'de', enabled: false },
  ...
  { id: 'netzpolitik', name: 'Netzpolitik.org', url: 'https://netzpolitik.org/feed/', category: 'politik', language: 'de', enabled: true },
  ...
  { id: 'noen-gf', name: 'NÖN Gänserndorf', url: 'https://www.noen.at/gaenserndorf/xml/rss', category: 'lokal', language: 'de', enabled: false },
  { id: 'noen-gd', name: 'NÖN Gmünd', url: 'https://www.noen.at/gmuend/xml/rss', category: 'lokal', language: 'de', enabled: false },
  { id: 'noen-ha', name: 'NÖN Haag', url: 'https://www.noen.at/haag/xml/rss', category: 'lokal', language: 'de', enabled: false },
  { id: 'noen-he', name: 'NÖN Herzogenburg', url: 'https://www.noen.at/herzogenburg/xml/rss', category: 'lokal', language: 'de', enabled: false },
  { id: 'noen-hl', name: 'NÖN Hollabrunn', url: 'https://www.noen.at/hollabrunn/xml/rss', category: 'lokal', language: 'de', enabled: false },
  { id: 'noen-ho', name: 'NÖN Horn', url: 'https://www.noen.at/horn/xml/rss', category: 'lokal', language: 'de', enabled: false },
  { id: 'noen-kg', name: 'NÖN Klosterneuburg', url: 'https://www.noen.at/klosterneuburg/xml/rss', category: 'lokal', language: 'de', enabled: false },
  { id: 'noen-ko', name: 'NÖN Korneuburg', url: 'https://www.noen.at/korneuburg/xml/rss', category: 'lokal', language: 'de', enabled: false },
  { id: 'noen-kr', name: 'NÖN Krems', url: 'https://www.noen.at/krems/xml/rss', category: 'lokal', language: 'de', enabled: false },
  { id: 'noen-lf', name: 'NÖN Lilienfeld', url: 'https://www.noen.at/lilienfeld/xml/rss', category: 'lokal', language: 'de', enabled: false },
  { id: 'noen-me', name: 'NÖN Melk', url: 'https://www.noen.at/melk/xml/rss', category: 'lokal', language: 'de', enabled: false },
  { id: 'noen-mi', name: 'NÖN Mistelbach', url: 'https://www.noen.at/mistelbach/xml/rss', category: 'lokal', language: 'de', enabled: false },
  { id: 'noen-md', name: 'NÖN Mödling', url: 'https://www.noen.at/moedling/xml/rss', category: 'lokal', language: 'de', enabled: false },
  { id: 'noen-nb', name: 'NÖN Neulengbach', url: 'https://www.noen.at/neulengbach/xml/rss', category: 'lokal', language: 'de', enabled: false },
  { id: 'noen-nk', name: 'NÖN Neunkirchen', url: 'https://www.noen.at/neunkirchen/xml/rss', category: 'lokal', language: 'de', enabled: true },
  { id: 'noen-pt', name: 'NÖN Pielachtal', url: 'https://www.noen.at/pielachtal/xml/rss', category: 'lokal', language: 'de', enabled: false },
  { id: 'noen-pu', name: 'NÖN Purkersdorf', url: 'https://www.noen.at/purkersdorf/xml/rss', category: 'lokal', language: 'de', enabled: false },
  { id: 'noen-sw', name: 'NÖN Schwechat', url: 'https://www.noen.at/schwechat/xml/rss', category: 'lokal', language: 'de', enabled: false },
  { id: 'noen-st', name: 'NÖN St. Pölten', url: 'https://www.noen.at/st-poelten/xml/rss', category: 'lokal', language: 'de', enabled: false },
  { id: 'noen-tu', name: 'NÖN Tulln', url: 'https://www.noen.at/tulln/xml/rss', category: 'lokal', language: 'de', enabled: false },
  { id: 'noen-wt', name: 'NÖN Waidhofen/Thaya', url: 'https://www.noen.at/waidhofen/xml/rss', category: 'lokal', language: 'de', enabled: false },
  { id: 'noen-wn', name: 'NÖN Wiener Neustadt', url: 'https://www.noen.at/wr-neustadt/xml/rss', category: 'lokal', language: 'de', enabled: true },
  { id: 'noen-yb', name: 'NÖN Ybbstal', url: 'https://www.noen.at/ybbstal/xml/rss', category: 'lokal', language: 'de', enabled: false },
  { id: 'noen-zt', name: 'NÖN Zwettl', url: 'https://www.noen.at/zwettl/xml/rss', category: 'lokal', language: 'de', enabled: false },

  // ══════════════════════════════════════════════════════════════════════════
  // TECHNOLOGIE — Deutsch
  // ══════════════════════════════════════════════════════════════════════════
  { id: 'golem', name: 'Golem.de', url: 'https://rss.golem.de/rss.php?feed=RSS2.0', category: 'tech', language: 'de', enabled: true },
  { id: 'ccc', name: 'CCC Updates', url: 'https://www.ccc.de/de/rss/updates.xml', category: 'tech', language: 'de', enabled: true },
  ...
  { id: 'heise-ct', name: 'c\'t Magazin', url: 'https://www.heise.de/ct/feed.xml', category: 'tech', language: 'de', enabled: true },
  { id: 'heise-make', name: 'Make: Hardware Hacks', url: 'https://www.heise.de/make/rss/hardware-hacks-atom.xml', category: 'maker', language: 'de', enabled: true },
  { id: 'heise-foto', name: 'Heise Foto', url: 'https://www.heise.de/foto/feed.xml', category: 'fotografie', language: 'de', enabled: true },
  { id: 'heise-entertainment', name: 'Heise Entertainment', url: 'https://www.heise.de/rss/heise-Rubrik-Entertainment-atom.xml', category: 'film', language: 'de', enabled: true },
  { id: 't3n', name: 't3n', url: 'https://t3n.de/rss.xml', category: 'tech', language: 'de', enabled: true },
  { id: 'winfuture', name: 'WinFuture', url: 'https://static.winfuture.de/feeds/WinFuture-News-rss2.0.xml', category: 'tech', language: 'de', enabled: true },
  { id: 'netzwelt', name: 'Netzwelt', url: 'https://feeds.feedburner.com/netzwelt', category: 'tech', language: 'de', enabled: true },
  { id: 'chip', name: 'CHIP Online', url: 'https://www.chip.de/rss/chip_komplett.xml', category: 'tech', language: 'de', enabled: true },
  { id: 'computerbild', name: 'Computerbild', url: 'https://www.computerbild.de/rss/35011529.xml', category: 'tech', language: 'de', enabled: true },
  ...
  { id: 'verge', name: 'The Verge', url: 'https://www.theverge.com/rss/index.xml', category: 'tech', language: 'en', enabled: true },
  { id: 'wired', name: 'Wired', url: 'https://www.wired.com/feed/rss', category: 'tech', language: 'en', enabled: true },
  { id: 'techcrunch', name: 'TechCrunch', url: 'https://techcrunch.com/feed/', category: 'tech', language: 'en', enabled: true },
  { id: 'engadget', name: 'Engadget', url: 'https://www.engadget.com/rss.xml', category: 'tech', language: 'en', enabled: true },
  ...
  { id: 'tomshardware', name: "Tom's Hardware", url: 'https://www.tomshardware.com/feeds/all', category: 'tech', language: 'en', enabled: true },
  ...
  // APPLE & MAC
  // ══════════════════════════════════════════════════════════════════════════
  { id: 'apfellike', name: 'Apfellike', url: 'https://feeds.feedburner.com/apfellike', category: 'mac', language: 'de', enabled: true },
  { id: 'apfelpage', name: 'Apfelpage', url: 'https://www.apfelpage.de/feed/', category: 'mac', language: 'de', enabled: true },
  { id: 'heise-mac', name: 'Mac & i', url: 'https://www.heise.de/mac-and-i/feed.xml', category: 'mac', language: 'de', enabled: true },
  { id: 'macgadget', name: 'MacGadget', url: 'https://www.macgadget.de/rss.xml', category: 'mac', language: 'de', enabled: true },
  { id: 'macwelt', name: 'Macwelt', url: 'https://www.macwelt.de/feed', category: 'mac', language: 'de', enabled: true },
  { id: '9to5mac', name: '9to5Mac', url: 'https://9to5mac.com/feed/', category: 'mac', language: 'en', enabled: true },
  { id: 'appleinsider', name: 'AppleInsider', url: 'https://appleinsider.com/rss/news/', category: 'mac', language: 'en', enabled: true },
  { id: 'daring-fireball', name: 'Daring Fireball', url: 'https://daringfireball.net/feeds/main', category: 'mac', language: 'en', enabled: true },
  { id: 'macrumors', name: 'MacRumors', url: 'https://feeds.macrumors.com/MacRumors-All', category: 'mac', language: 'en', enabled: true },
  { id: 'macstories', name: 'MacStories', url: 'https://www.macstories.net/feed/', category: 'mac', language: 'en', enabled: true },
  { id: 'six-colors', name: 'Six Colors', url: 'https://sixcolors.com/feed/', category: 'mac', language: 'en', enabled: true },
  ...
  { id: 'hn', name: 'Hacker News', url: 'https://hnrss.org/frontpage', category: 'web', language: 'en', enabled: true },
  ...
  { id: '9to5google', name: '9to5Google', url: 'https://9to5google.com/feed/', category: 'android', language: 'en', enabled: true },
  ...
  // GAMING & GEEK
  // ══════════════════════════════════════════════════════════════════════════
  { id: 'gamestar', name: 'GameStar', url: 'https://www.gamestar.de/news/rss/news.rss', category: 'gaming', language: 'de', enabled: true },
  ...
  { id: 'rps', name: 'Rock Paper Shotgun', url: 'https://www.rockpapershotgun.com/feed', category: 'gaming', language: 'en', enabled: true },
  { id: 'kotaku', name: 'Kotaku', url: 'https://kotaku.com/rss', category: 'gaming', language: 'en', enabled: true },
  { id: 'hackaday', name: 'Hackaday', url: 'https://hackaday.com/blog/feed/', category: 'gaming', language: 'en', enabled: false },

  // ══════════════════════════════════════════════════════════════════════════
  // FILM & SERIEN
  // ══════════════════════════════════════════════════════════════════════════
  { id: 'filmstarts', name: 'Filmstarts', url: 'https://www.filmstarts.de/rss/nachrichten.xml', category: 'film', language: 'de', enabled: true },
  { id: 'filmfix', name: 'Filmfix', url: 'https://filmfix.de/feed/', category: 'film', language: 'de', enabled: true },
  { id: 'kinofans', name: 'Kinofans', url: 'https://kinofans.com/category/news/feed/', category: 'film', language: 'de', enabled: true },
  { id: 'kino-zeit', name: 'Kino-Zeit', url: 'https://feeds.feedburner.com/kino-zeit/oNnQ', category: 'film', language: 'de', enabled: true },
  { id: 'moviepilot', name: 'Moviepilot', url: 'https://www.moviepilot.de/rss/moviepilot-standard', category: 'film', language: 'de', enabled: true },
  { id: 'serienjunkies', name: 'Serienjunkies.de', url: 'https://www.serienjunkies.de/rss/news.xml', category: 'film', language: 'de', enabled: true },
  { id: 'slashfilm', name: '/Film', url: 'https://www.slashfilm.com/feed/', category: 'film', language: 'en', enabled: true },
  { id: 'screenrant', name: 'Screen Rant', url: 'https://screenrant.com/feed/', category: 'film', language: 'en', enabled: true },
  { id: 'variety', name: 'Variety', url: 'https://variety.com/feed/', category: 'film', language: 'en', enabled: true },
  { id: 'indiewire', name: 'IndieWire', url: 'https://www.indiewire.com/feed/', category: 'film', language: 'en', enabled: true },
  ...
  { id: 'codrops', name: 'Codrops', url: 'https://tympanus.net/codrops/feed/', category: 'design', language: 'en', enabled: true },
  { id: 'abduzeedo', name: 'Abduzeedo', url: 'https://abduzeedo.com/feed', category: 'design', language: 'en', enabled: true },
  ...
  // FOTOGRAFIE
  // ══════════════════════════════════════════════════════════════════════════
  { id: 'petapixel', name: 'PetaPixel', url: 'https://petapixel.com/feed/', category: 'fotografie', language: 'en', enabled: true },
  { id: 'dps', name: 'Digital Photography School', url: 'https://digital-photography-school.com/feed', category: 'fotografie', language: 'en', enabled: true },

  // ══════════════════════════════════════════════════════════════════════════
  // DIY & MAKER
  // ══════════════════════════════════════════════════════════════════════════
  { id: 'make-mag', name: 'Make Magazine', url: 'https://makezine.com/feed/', category: 'maker', language: 'en', enabled: true },

  // ══════════════════════════════════════════════════════════════════════════
  // AUTOMOBIL
  // ══════════════════════════════════════════════════════════════════════════
  { id: 'auto-ms', name: 'Auto Motor Sport', url: 'https://www.auto-motor-und-sport.de/rss/alle/', category: 'auto', language: 'de', enabled: false },
  { id: 'autobild', name: 'Auto Bild', url: 'https://www.autobild.de/rss/22590661.xml', category: 'auto', language: 'de', enabled: true },
  ...
  { id: 'runnersworld-de', name: "Runner's World (DE)", url: 'https://www.runnersworld.de/rss/news/', category: 'sport', language: 'de', enabled: true },
  { id: 'fitforfun', name: 'Fit For Fun', url: 'https://www.fitforfun.de/rss', category: 'sport', language: 'de', enabled: true },
  { id: 'achim-achilles', name: 'Achim Achilles Blog', url: 'https://www.achilles-running.de/feed/', category: 'sport', language: 'de', enabled: true },
  { id: 'lauftipps', name: 'Lauftipps.ch', url: 'https://lauftipps.ch/feed/', category: 'sport', language: 'de', enabled: true },
  { id: 'fahrrad-wandern', name: 'Fahrrad & Wandern', url: 'https://blog.fahrrad-wandern.de/feed/', category: 'sport', language: 'de', enabled: true },
  { id: 'yogastern', name: 'Yogastern', url: 'https://yogastern.de/feed/', category: 'lifestyle', language: 'de', enabled: true },
  ...
  { id: 'goasia', name: 'Go Asia', url: 'https://goasia.de/feed/', category: 'reise', language: 'de', enabled: true },
  { id: 'fahrradreisen', name: 'Fahrrad- & Wanderreisen', url: 'https://www.fahrradreisen-wanderreisen.de/rss/news.asp?cat=982A438A-EB7E-472A-90CF-16F99286AC46', category: 'reise', language: 'de', enabled: true },
  { id: 'wanderreisen', name: 'Wanderreisen', url: 'https://www.wanderreisen-fahrradreisen.de/rss/news.asp?cat=DB101F42-3D4C-4008-A003-CB56293ED088', category: 'reise', language: 'de', enabled: true },
  { id: 'wander-wellness', name: 'Wander & Wellness', url: 'https://feeds.feedburner.com/Wander-WellnessMotorradhotelAmReschenpass', category: 'reise', language: 'de', enabled: true },
  { id: 'kreuzfahrtpiraten', name: 'Kreuzfahrtpiraten', url: 'https://www.kreuzfahrtpiraten.de/feed/', category: 'reise', language: 'de', enabled: true },

  // ══════════════════════════════════════════════════════════════════════════
  // FASHION & MODE
  // ══════════════════════════════════════════════════════════════════════════
  { id: 'vogue-de', name: 'Vogue Deutschland', url: 'https://www.vogue.de/feed/rss', category: 'fashion', language: 'de', enabled: true },
  ...
  { id: 'business-of-fashion', name: 'Business of Fashion', url: 'https://www.businessoffashion.com/arc/outboundfeeds/rss/?outputType=xml', category: 'fashion', language: 'en', enabled: false },
  ...
  { id: 'spiegel-literatur', name: 'Spiegel Literatur', url: 'https://www.spiegel.de/kultur/literatur/index.rss', category: 'magazine', language: 'de', enabled: true },
  { id: 'danislesestube', name: 'Danis Leselounge', url: 'https://www.danislesestube.com/feed/', category: 'magazine', language: 'de', enabled: true },
  { id: 'titanic-magazin', name: 'Titanic Magazin', url: 'https://www.titanic-magazin.de/newsticker/rss.xml', category: 'magazine', language: 'de', enabled: true },
  { id: 'sz-mag', name: 'SZ Magazin', url: 'https://www.sz-magazin.de/rss', category: 'magazine', language: 'de', enabled: true },
  { id: 'newyorker', name: 'The New Yorker', url: 'https://www.newyorker.com/feed/everything', category: 'magazine', language: 'en', enabled: true },
  ...
  { id: 'gq-en', name: 'GQ', url: 'https://www.gq.com/feed/rss', category: 'magazine', language: 'en', enabled: true },
  ...
  { id: 'netflix-new', name: 'Netflix – Neu', url: 'https://www.werstreamt.es/filme-serien/anbieter-netflix/option-flatrate/neu/', category: 'streaming', language: 'de', enabled: false },
  { id: 'disney-plus-new', name: 'Disney+ – Neu', url: 'https://www.werstreamt.es/filme-serien/anbieter-disney-plus/option-flatrate/neu/', category: 'streaming', language: 'de', enabled: false },
  ...
  { id: 'filmfriend-new', name: 'Filmfriend – Neu', url: 'https://www.werstreamt.es/filme-serien/anbieter-filmfriend/option-flatrate/neu/', category: 'streaming', language: 'de', enabled: false },
  { id: 'magentatv-new', name: 'MagentaTV – Neu', url: 'https://www.werstreamt.es/filme-serien/anbieter-magentatv/option-flatrate/neu/', category: 'streaming', language: 'de', enabled: false },
  { id: 'netzkino-new', name: 'Netzkino – Neu', url: 'https://www.werstreamt.es/filme-serien/anbieter-netzkino/option-flatrate/neu/', category: 'streaming', language: 'de', enabled: false },
