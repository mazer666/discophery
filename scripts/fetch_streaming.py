...
PROVIDERS = [
    {
        ...
        'rss':   f'{BASE}/filme-serien/anbieter-prime-video/option-flatrate/neu/?rss',
        'slug':  'amazon-prime',
    },
    {
        'id':    'netflix-new',
        'name':  'Netflix – Neu',
        'label': 'Netflix',
        'rss':   f'{BASE}/filme-serien/anbieter-netflix/option-flatrate/neu/?rss',
        'slug':  'netflix',
    },
    {
        'id':    'disney-plus-new',
        'name':  'Disney+ – Neu',
        'label': 'Disney+',
        'rss':   f'{BASE}/filme-serien/anbieter-disney-plus/option-flatrate/neu/?rss',
        'slug':  'disney-plus',
    },
    {
        'id':    'apple-tv-new',
        'name':  'Apple TV+ – Neu',
        'label': 'Apple TV+',
        'rss':   f'{BASE}/filme-serien/anbieter-apple-tv/option-flatrate/neu/?rss',
        'slug':  'apple-tv',
    },
    {
        'id':    'filmfriend-new',
        'name':  'Filmfriend – Neu',
        'label': 'Filmfriend',
        'rss':   f'{BASE}/filme-serien/anbieter-filmfriend/option-flatrate/neu/?rss',
        'slug':  'filmfriend',
    },
    {
        'id':    'magentatv-new',
        'name':  'MagentaTV – Neu',
        'label': 'MagentaTV',
        'rss':   f'{BASE}/filme-serien/anbieter-magentatv/option-flatrate/neu/?rss',
        'slug':  'magentatv',
    },
    {
        'id':    'netzkino-new',
        'name':  'Netzkino – Neu',
        'label': 'Netzkino',
        'rss':   f'{BASE}/filme-serien/anbieter-netzkino/option-flatrate/neu/?rss',
        'slug':  'netzkino',
    },
]
